...
<div class="container-fluid right_color">
    <div class="page-main-header">
        <!-- Page Title -->
        <h2 class="page-name-title">Delete Submodel</h2>
        <!--  Breadcrumb -->
        <ol class="breadcrumb">
            <li><a href="#">Home</a></li>
    ...
    <div class="contain-section">
        <div class="contain-inner-section">
            ...
            <form action="<?php echo base_url('manufacturer/deletesubmodel/'.$id) ?>" method="post">
                <input type="submit" class="btn btn-primary" name="confirm" value="Confirm">
                <a href="<?php echo base_url('manufacturer/create') ?>" class="btn btn-warning">Cancel</a>
            </form>
        </div>
    </div>
