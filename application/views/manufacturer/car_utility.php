            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="section-body">
                        ...
                        <button type="button" class="btn btn-sm btn-success btn-outline float-button-light waves-effect waves-button waves-float waves-light" data-toggle="modal" data-target="#modelModal">Add Fuel Type</button>
                        <button type="button" class="btn btn-sm btn-info btn-outline float-button-light waves-effect waves-button waves-float waves-light" data-toggle="modal" data-target="#subModelModal">Add Transmission</button>
                        <button type="button" class="btn btn-sm btn-info btn-outline float-button-light waves-effect waves-button waves-float waves-light" data-toggle="modal" data-target="#subModelModal">Add Emission</button>
                    </div>
                </div>
