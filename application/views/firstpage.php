                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#testimonials" class="menu-item">About</a></li>
                            <li class="scroll-to-section"><a href="#about" class="menu-item">Services</a>
                            </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <h1>Committed  to Delivering <em>Innovative and High Designing</em></h1>
                        ...
                        <a href="#testimonials" class="main-button-slider">KNOW US BETTER</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sub-footer">
                        <p>Copyright &copy; 2021 My Car Account
