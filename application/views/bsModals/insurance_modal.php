        ...
        <form action="<?php echo base_url().'Manufacturer/color_create/'; ?>" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Add Insurance Comapny</h4>
                </div>
                <div class="modal-body">
                    <textarea class="form-control" required style="height:260px;" name="utility_name" spellcheck="false"></textarea>
                    <input type="hidden" value="Insurance" name="type">
                    &nbsp;
                    <div class="alert alert-info">Put one or more color name as "," (comma) separated. Like LIC,ABD,XYZ</div>
